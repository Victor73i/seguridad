                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="mt-4 pt-2">
                                ...
                                <div class="mt-4">
                                    <a href="<?php echo e(route('login')); ?>" class="btn btn-success w-100">Iniciar Sesion</a>
                                </div>
                            </div>
                        </div>
                        <!-- end card body -->
...
<?php $__env->startSection('script'); ?>
        <script>
            setTimeout(function(){
                window.location.href = "<?php echo e(route('login')); ?>"; // Cambia esto a la ruta de tu login
            }, 20000); // 20 segundos
        </script>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\glpi-insumos\resources\views/auth-logout-basic.blade.php ENDPATH**/ ?>